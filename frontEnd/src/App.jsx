...
const EditItem = lazy(() => import("./pages/protectedPages/dashBoard/item/EditItem.jsx"));
const ViewItem = lazy(() => import("./pages/protectedPages/dashBoard/item/ViewItem.jsx"));
      ...
      <Suspense fallback={<Loading />}>
        <Routes>
          ...
          >
            ...
            <Route path="items/view/:id" element={<ViewItem />} />
